function plot_zstate_with_error(n, lower, upper, t, z_d, ts, z, name, label_state, label_error, options, show_bound, pos_offset, savename)
    ...
    ylabel(label_error, 'interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', label_font_size)
