...
function plot_wrench(t, u, u_d, u_f_r, options)
    ...
    labely = ylabel(ax1, "${\mathbf{u}_f}_x$ (N)", 'interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', 12);
    ...
    ylim([-50, 50])
    labely = ylabel(ax2, '${\mathbf{u}_f}_y (N)$', 'interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', 12);
    labely.Position(1) = labely_pos;
    ...
    ylim([-100, 100])
    labely = ylabel(ax3, '${\mathbf{u}_f}_z$ (N)', 'interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', 12);
    labely.Position(1) = labely_pos;
    ...
    ylim([-2, 2]);
    labely = ylabel(ax4, '${\mathbf{u}_\tau}_x$ (Nm)', 'interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', 12);
    labely.Position(1) = labely_pos;
    ...
    ylim([-2, 2]);
    labely = ylabel(ax5, '${\mathbf{u}_\tau}_y$ (Nm)', 'interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', 12);
    labely.Position(1) = labely_pos;
    ...
    ylim([-2, 2]);
    labely = ylabel(ax6, '${\mathbf{u}_\tau}_z$ (Nm)', 'interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', 12);
    labely.Position(1) = labely_pos;
