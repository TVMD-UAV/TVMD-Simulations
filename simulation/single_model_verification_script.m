...
close all
run('initialization/init_params.m')
open_system('single_system_2021b1');
...
save(matfilename, 'drone_params', 'env_params', 'ctrl_params', 'out', 'dt', 'initial_state_x0');
...
function [simIn, options, ctrl_params, initial_state_x0] = regulation_hover(simIn, ctrl_params)
    ...
    projectpath = "C:\\Users\\NTU\\Documents\\Projects\\Multidrone\\outputs\\single_regulation";
    projectname = "hovering";
    filename = "sing_reg_hover";
