...
function drone_params = gen_drone_params(env_params, conf_name)
    ...
    drone_params.sigma_a = pi / 6;
    drone_params.sigma_b = pi / 6;
    drone_params.r_sigma_a = 50 * pi / 6; % eta, x-axis
    drone_params.r_sigma_b = 50 * pi / 6; % xi, y-axis

    % Motor Constraints
    drone_params.f_max = 2.0 * drone_params.m * env_params.g;
    drone_params.r_f = 50;

    drone_params.sigma_w0 = 0;
    drone_params.sigma_w = 600;
...
function ctrl_params = gen_ctrl_params()
    ...
    ctrl_params.attitude_planner_relax_ratio = 0.5;
...
function traj_params = gen_traj_params()
    ...
    traj_params.T_tilt = 6;
    traj_params.T = 2;

    traj_params.up_time = 2;
    traj_params.hover_time = 10;
    traj_params.land_time = 2;
    traj_params.shutdown_time = 2;
